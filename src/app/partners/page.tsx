...
export const metadata = makeMetadata({
  ...
  description: "Partners en netwerk rond Kwartier West: soundsystems, collectieven, projecten en digitale samenwerking.",
