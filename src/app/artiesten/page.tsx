...
export const metadata = makeMetadata({
  ...
  og: "https://kwartierwest.be/artiesten/opengraph-image",
});
...
export default function ArtiestenPage() {
  return (
    <main id="main" className="artists-page" data-page="artiesten">
      ...
      <section className="roster-hero" data-roster-hero="">
        <div className="roster-hero-count"><b>{artists.length}</b><span>ARTIESTEN</span></div>
        <div className="roster-hero-sheet"><RosterBoard /></div>
        <div className="roster-hero-copy"><span>03 / ROSTER</span><h1>Van machines<br />tot bars.</h1><p>Rappers, producers, DJ's en live-acts uit de Tekno- en Hip hopwerking van Kwartier West.</p></div>
      </section>
      <ArtistIndex />
    </main>
  );
