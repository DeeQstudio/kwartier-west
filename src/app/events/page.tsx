...
export const metadata = makeMetadata({
  ...
  description: "Actuele events en archief van Kwartier West. Villa West sluit af op vrijdag 28 augustus 2026 bij Villa Bota in Brugge.",
  ...
  return (
    <main id="main" className="events-page" data-page="events">
      ...
      <section className="events-hero events-hero--current" data-events-hero="">
        <div className="events-poster-a"><img src="/assets/media/events/villa-west-2026-08-28.jpg" alt="Villa West 28 augustus 2026" /></div>
        ...
        <div className="events-hero-title">
          ...
          <h1>EVENTS</h1>
          <p>De laatste Villa West vindt plaats op vrijdag 28 augustus, live vanuit Villa Bota.</p>
        </div>
      </section>

      <section className="event-status section-pad event-status--live">
        <div><span className="eyebrow">Actueel / Villa West</span><h2>Villa West<br />28.08.2026</h2></div>
        <div className="event-status-live-copy">
          <p>Natte23 speelt van 22:00 tot 23:00. Alexer neemt het laatste uur over tot middernacht.</p>
      ...
      <section className="event-grid section-pad">
        <Link className="event-card event-card--poster event-card--main" href="/events/villa-west-2026">
          <figure><img src="/assets/media/events/villa-west-2026-08-28.jpg" alt="Villa West poster 28 augustus 2026" /></figure>
          <div><span>28.08.2026 / Villa Bota / laatste editie</span><h2>Villa West</h2><p>Natte23 / Alexer / Tekno-livesets / livestream</p></div>
        </Link>
