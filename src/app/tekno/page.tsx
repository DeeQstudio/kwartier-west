...
export const metadata = makeMetadata({
  title: "Tekno | Kwartier West Brugge",
  description: "Tekno bij Kwartier West: acid, tribe, hardtekk, live-sets, producers en soundsystemcultuur uit Brugge en daarbuiten.",
