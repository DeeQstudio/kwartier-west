...
export const metadata = makeMetadata({
  title: "Kwartier West | Tekno, Hip hop, artiesten & events in Brugge",
  description: "Kwartier West is een collectief uit Brugge voor Tekno en Hip hop, met artiesten, live events, samenwerkingen en een centrale boekingsdesk.",
