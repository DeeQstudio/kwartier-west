...
export const metadata = makeMetadata({
  ...
  description:
    "Kwartier West is een West-Vlaams collectief voor Tekno en Hip hop, met artiesten, events, samenwerkingen en een centrale boekingsdesk.",
    ...
    <main id="main" className="home" data-page="home">
      ...
      <section className="home-hero" data-home-hero="">
        <div className="home-sticky">
          <div
            className={`hero-red-field ${styles.introField}`}
            aria-hidden="true"
          />

          <div className="hero-photo hero-photo--l">
            <img
              src="/assets/media/archive/teknorelics-06.webp"
              alt="Tekno-event van Kwartier West"
            />
          </div>
          <div className="hero-photo hero-photo--r">
            <img
              src="/assets/media/scenes/hiphop-crowd.jpg"
              alt="Hip hop publiek en performers tijdens een liveshow"
            />
          </div>
      ...
      <section className="statement section-pad">
        <div className="statement-index">00 / Kwartier West</div>
        <h1>
          Twee scenes.
          <br />
          Eén collectief.
        ...
        <div className="statement-copy">
          <p data-reveal="">
            Kwartier West brengt Tekno en Hip hop samen in een West-Vlaams collectief rond artiesten,
            events, samenwerkingen en bookings.
          </p>
          <Link className="text-link" href="/manifest">
            Waar we voor staan
          </Link>
        </div>
      </section>

      <section className="home-scene home-scene--tek" data-scene-chapter="">
        <Link href="/tekno" className="scene-image scene-image--tekno-photo">
          <img
            src="/assets/media/archive/teknorelics-04.webp"
            alt="Soundsystem tijdens een Kwartier West-event"
          />
        </Link>
        <div className="scene-info">
          ...
          <h2>Tekno</h2>
          <p>
            Acid, tribe, hardtekk, live hardware, DJ-sets en soundsystems. Gebouwd voor donkere zalen,
            zware systemen en lange nachten.
          </p>
          <Link className="arrow-link" href="/tekno">
            Open Tekno <span>↗</span>
          </Link>
        </div>
      </section>

      <section className="home-scene home-scene--hip" data-scene-chapter="">
        <div className="scene-info">
          <span>02 / Scene</span>
          <h2>Hip hop</h2>
          <p>
            Rappers, producers en live-acts binnen de West-Vlaamse hiphopscene. Bars, beats en
            samenwerkingen met een eigen stem.
          </p>
          <Link className="arrow-link" href="/hiphop">
            Open Hip hop <span>↗</span>
          </Link>
        </div>
        <Link href="/hiphop" className="scene-image scene-image--hiphop-photo">
          <img
            src="/assets/media/scenes/hiphop-kwkr-tuffer.webp"
            alt="De Kweker tijdens een liveoptreden"
      ...
      <section className="network-home section-pad">
        <div>
          <span className="eyebrow">05 / Netwerk</span>
          <h2>Partners en organisaties rond Kwartier West.</h2>
        </div>
        <div className="network-logo-line">
          ...
          <Link href="/partners#acidelics">
            <img src="/assets/partners/acidelics.webp" alt="Acidelics" loading="lazy" />
          </Link>
          <Link href="/partners#spoorloos-soundsystem">
            <img src="/assets/partners/spoorloos-soundsystem.webp" alt="Spoorloos Soundsystem" loading="lazy" />
          </Link>
          <Link href="/partners#deeqstudio">
            <img src="/assets/partners/deeqstudio.svg" alt="DEEQSTUDIO" loading="lazy" />
          </Link>
        </div>
      ...
      <section className="home-close home-booking-close">
        <div className="home-booking-close-copy">
          <span>06 / Booking</span>
          <h2>Van één artiest tot een volledige takeover.</h2>
          <p>
            Boek een solo-act, meerdere artiesten, de Tekno- of Hip hopscene, of een volledige Kwartier
            West-programmatie.
          </p>
        </div>
        <Link href="/booking">
          Open boekingsdesk <span>↗</span>
        </Link>
      </section>
    </main>
  );
