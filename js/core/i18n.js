...
const EN = {
  ...
  "meta.archive.description": "Archive of past Kwartier West events with photos and videos.",
  ...
  "archive.hero.lead": "Past nights in photos and videos.",
  ...
  "archive.profile.lead": "Pick an event.",
  ...
  "archive.edition.eye.summary": "Photos from Teknorelics: Eye of the Temple.",
  ...
  "newsletter.section.eventsTitle": "Westpost Circle",
  "newsletter.section.eventsLead": "Sign up and get event updates, line-up drops and ticket news first.",
  "newsletter.section.bookingTitle": "Westpost Circle",
  "newsletter.section.bookingLead": "Follow booking windows, event drops and label updates.",
  "newsletter.title": "Westpost Circle",
  "newsletter.lead": "One update line for everything moving inside Kwartier West.",
  ...
  "newsletter.form.submit": "Join Westpost",
  ...
  "newsletter.result.success": "You are subscribed to Westpost.",
...
const NL = {
  ...
  "meta.home.title": "Kwartier West",
  "meta.home.description": "Kwartier West: Tekno en Hip hop, events, bookings en merch.",
  "meta.tekno.title": "Kwartier West - Tekno",
  ...
  "meta.events.description": "Eventhub met Tekno- en Hip hop-line-ups, tickets en officiële bronkanalen.",
  "meta.archive.title": "Kwartier West - Archief",
  "meta.archive.description": "Archief van voorbije Kwartier West-events met foto's en video's.",
  ...
  "meta.booking.description": "Centrale bookingsdesk voor Tekno, Hip hop en volledige overnames.",
  ...
  "meta.contact.title": "Kwartier West - Contact",
  "meta.contact.description": "Contacteer Kwartier West voor bookings, samenwerkingen en productie.",
  "meta.manifest.title": "Kwartier West - Manifest",
  "meta.manifest.description": "Manifest van Kwartier West: visie, waarden en werking.",
  "meta.partners.title": "Kwartier West - Partners",
  "meta.partners.description": "Partners van Kwartier West voor productie, visuals, sound en organisatie.",
  "meta.tickets.title": "Kwartier West - Tickets",
  "meta.tickets.description": "Ticket- en toegangsinfo voor Kwartier West-events.",
  ...
  "landing.portal.instruction": "Klik om binnen te komen.",
  "landing.tekno.eyebrow": "Tekno collectief",
  "landing.tekno.title": "Tekno",
  "landing.tekno.desc": "Hardtekk, acid en soundsystemdiscipline.",
  ...
  "footer.title.label": "Label",
  "footer.title.info": "Info",
  "footer.note.appSoon": "App-integratie: komt later",
  "footer.note.privacySoon": "Privacy: komt later",
  "footer.note.termsSoon": "Voorwaarden: komen later",

  "tekno.hero.eyebrow": "Kwartier West / Tekno",
  "tekno.hero.title": "Tekno collectief",
  "tekno.hero.lead": "Raves en livesets voor zware soundsystems.",
  ...
  "hiphop.hero.lead": "Bars, producers en performers voor echte stages.",
  ...
  "events.hero.title": "Evenementen",
  "events.hero.lead": "Een feed voor Tekno en Hip hop.",
  ...
  "archive.hero.lead": "Voorbije nachten in foto's en video's.",
  ...
  "archive.profile.lead": "Kies een event.",
  ...
  "archive.edition.eye.summary": "Foto's van Teknorelics: Eye of the Temple.",
  ...
  "newsletter.section.eventsTitle": "Westpost club",
  "newsletter.section.eventsLead": "Schrijf je in voor updates over events, line-ups en ticketdrops.",
  "newsletter.section.bookingTitle": "Westpost club",
  "newsletter.section.bookingLead": "Blijf op de hoogte van bookings, eventdrops en labelnieuws.",
  "newsletter.title": "Westpost",
  "newsletter.lead": "Updates uit Kwartier West.",
  ...
  "newsletter.result.success": "Je bent ingeschreven op Westpost.",
  ...
  "booking.hero.lead": "Kies je aanvraag en verstuur.",
  ...
  "booking.form.helper": "Na versturen bevestig je via e-mail.",
  "booking.form.placeholder.eventName": "Warehouse Pressure Night",
  "booking.form.placeholder.city": "Roeselare",
  ...
  "partners.hero.title": "Partners",
  "partners.hero.lead": "Studio's, crews en operators in het West-netwerk.",
  "partners.hero.events": "Evenementenhub",
  "partners.hero.become": "Word partner",
  "partners.protocol.title": "Hoe we samenwerken",
  "partners.protocol.one": "Eerst heldere afspraken over productie, timing en rollen.",
  "partners.protocol.two": "Duidelijke communicatiekanalen en snelle opvolging.",
  "partners.protocol.three": "Samenwerkingen die kloppen en blijven werken.",
  "partners.protocol.cta": "Ga naar contactdesk",

  "contact.hero.eyebrow": "Contact / Productie",
  "contact.hero.title": "Contact Kwartier West",
  "contact.hero.lead": "Voor bookings, productie en samenwerkingen.",
  ...
  "contact.tile.bookings.body": "Verstuur solo-, multi- of collectiefaanvragen via één intake.",
  ...
  "contact.tile.integration.body": "De app komt later. Bookings, events en shop lopen nu via deze site.",
  "contact.tile.integration.cta": "Bekijk planning",

  "manifest.hero.eyebrow": "Dit is het Westen",
  "manifest.hero.title": "Manifest",
  "manifest.hero.lead": "Twee kanten, één standaard.",
  "manifest.why.title": "Waarom twee kanten",
  "manifest.why.body": "Tekno en Hip hop hebben hun eigen podiumtaal, met dezelfde ruggengraat in planning en productie.",
  ...
  "manifest.rules.three": "Communicatie met organisatoren en venues is helder en snel.",
  "manifest.rules.four": "We bouwen nu al met de basis voor de app van morgen.",
  ...
  "tickets.hero.title": "Tickets",
  "tickets.hero.lead": "Ticketstatus wordt per event beheerd in de eventhub.",
