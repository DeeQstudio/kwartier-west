...
const EN = {
  ...
  "booking.form.helper": "After submit, confirm your request via email. Then we send it automatically.",
...
const NL = {
  ...
  "meta.bookingVerify.description": "Bevestig je bookingaanvraag via e-mailverificatie.",
  ...
  "booking.form.helper": "Na versturen bevestig je je aanvraag via e-mail. Daarna verzenden we automatisch.",
  "booking.form.placeholder.eventName": "Warehouse Pressure Night",
  "booking.form.placeholder.city": "Roeselare",
  ...
  "booking.result.webhookDisabled": "Automatische verzending is nog niet geconfigureerd.",
  ...
  "booking.result.verifyBody": "We hebben een verificatiemail verstuurd. Open die link om je booking definitief te bevestigen.",
  ...
  "booking.result.verifySpamHint": "Niets ontvangen? Kijk in spam/promoties en probeer opnieuw.",
  "booking.verify.eyebrow": "Boeking / E-mailverificatie",
  "booking.verify.heroTitle": "Bevestig je booking",
  "booking.verify.heroLead": "Na je bevestiging sturen we je aanvraag direct door naar het Kwartier West team.",
  "booking.verify.loadingTitle": "Aanvraag verifieren...",
  "booking.verify.loadingBody": "Even geduld, we valideren je bevestigingslink.",
